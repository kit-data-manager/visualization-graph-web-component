...
Hide properties
<Canvas>
  <Story id="components-visualizationcomponent--hide-properties" />
</Canvas>
This story allows for dynamic input of JSON data, providing a way to visualize custom datasets.
Enter Data
<Canvas>
  <Story id="components-visualizationcomponent--enter-data" />
</Canvas>
